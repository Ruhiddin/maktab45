...
export default function FilterBar({
  ...
  return (
    <div
      className="sticky top-4 z-30 p-4 rounded-2xl bg-white/30 dark:bg-black/30 backdrop-blur-md border border-white/20 shadow-lg flex flex-wrap gap-3 items-center"
      role="region"
      aria-label={m.public.filters}
    >
      <div className="flex items-center gap-3 mr-auto flex-wrap">
        <h2 className="text-lg font-bold text-gray-800 dark:text-gray-100">{m.public.filters}</h2>
        {showMyClass && (
          <button
            type="button"
            onClick={onMyClass}
        ...
        {yearOptions.length > 0 && (
          <div className="flex items-center gap-1 rounded-full border border-gray-200/80 bg-white/55 p-1 shadow-sm dark:border-white/10 dark:bg-black/25">
      ...
      <div className="flex flex-wrap gap-2 w-full">
        ...
        <input
          ...
          className="p-2 rounded-lg bg-white/50 dark:bg-black/50 border border-gray-200 dark:border-gray-700 outline-none flex-[2] text-sm min-w-[180px] text-gray-800 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-400/60"
        />

        <div className="flex items-center gap-1 ml-auto bg-white/40 dark:bg-black/40 border border-gray-200 dark:border-gray-700 rounded-lg p-1">
          <button
            type="button"
